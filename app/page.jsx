      ...
      <header className="sticky top-0 z-50 bg-black border-b border-blood/20">
        <nav className="max-w-6xl mx-auto flex items-center justify-between px-6 py-3">
          ...
          <a
            ...
            className="hidden md:inline-flex items-center gap-2 font-mono text-xs uppercase tracking-widest bg-blood text-ink-950 px-4 py-2 rounded-sm shadow-[0_0_20px_rgba(225,6,0,0.55)] hover:shadow-[0_0_32px_rgba(255,26,26,0.9)] hover:bg-blood-glow hover:-translate-y-0.5 transition-all duration-200"
          >
        ...
        <div className="grid md:grid-cols-2 gap-16">
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-8 inline-flex items-center gap-3 font-mono text-sm uppercase tracking-widest bg-blood text-ink-950 px-6 py-3 rounded-sm shadow-[0_0_24px_rgba(225,6,0,0.6)] hover:shadow-[0_0_40px_rgba(255,26,26,0.95)] hover:bg-blood-glow hover:-translate-y-0.5 transition-all duration-200"
            >
