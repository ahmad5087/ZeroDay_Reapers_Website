      ...
      {open && (
        <div className="absolute left-0 right-0 top-full bg-black border-b border-blood/20 px-6 py-5 flex flex-col gap-1 font-mono text-xs uppercase tracking-widest shadow-xl">
          ...
          <a
            ...
            className="mt-4 flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-[#b30500] via-blood to-[#ff1a1a] text-white px-4 py-3 shadow-[0_0_20px_rgba(225,6,0,0.55)] active:scale-[0.99] transition"
          >
